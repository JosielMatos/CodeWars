...
// per liter (output) based on the number of miles per imperial gallon (input).

// Make sure to round off the result to two decimal points. If the answer
// ends with a 0, it should be rounded off without the 0. So instead of 5.50, we should get 5.5.
