...
// to pull all the cubes to a certain side of the box, d, which can be either 'L' or 'R' (left or right). Below 
// is an example of what a box of cubes might look like before and after switching gravity.
...
const flip=(d, c)=>{
  return d === 'L' ? c.sort((a,b) => b - a) : c.sort((a,b) => a - b)
}
