// Clever split
// You have a string. The string consists of words. Before words can be an 
// exclamation mark !. Also some words are marked as one set with square brackets []. 
// Your task is to split the string into separate words and sets.
